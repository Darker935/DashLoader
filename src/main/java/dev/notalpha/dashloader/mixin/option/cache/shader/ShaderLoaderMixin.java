...
public abstract class ShaderLoaderMixin {
	...
	private Map<ResourceLocation, Resource> skipCached(ResourceManager instance, String s, Predicate<ResourceLocation> identifierPredicate, Operation<Map<ResourceLocation, Resource>> original, @Local(ordinal = 0) ImmutableMap.Builder<ResourceLocation, ShaderProgramDefinition> builder, @Local(ordinal = 1) ImmutableMap.Builder<ShaderLoader.ShaderSourceKey, String> builder2) {
...
//	}
	...
	@WrapMethod(method = "prepare(Lnet/minecraft/server/packs/resources/ResourceManager;Lnet/minecraft/util/profiler/ProfilerFiller;)Lnet/minecraft/client/gl/ShaderLoader$Definitions;")
	private ShaderLoader.Definitions thing(ResourceManager resourceManager, ProfilerFiller profiler, Operation<ShaderLoader.Definitions> original) {
